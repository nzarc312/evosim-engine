...
int main() {
    ...
    // and a section header whose keys continue onto the next line.
    {
        const Config c = Config::from_string(
            ...
            "[food]       target_count = 20 ; spawn_rate = 5 ; energy_per_food = 25.5\n"
        ...
        CHECK(c.food.energy_per_food == 25.5);
